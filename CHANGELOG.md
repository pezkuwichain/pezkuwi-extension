...
- Update polkadot-api and polkadot-js dependecies  ([#1599](https://github.com/polkadot-js/extension/pull/1599))
...
- Update polkadot-api and polkadot-js dependecies  ([#1596](https://github.com/polkadot-js/extension/pull/1596))
...
- Update @polkadot/phishing  ([#1593](https://github.com/polkadot-js/extension/pull/1593))
...
- Update polkadot-api and polkadot-js ([#1582](https://github.com/polkadot-js/extension/pull/1582))
...
- Upgrade @polkadot/deps ([#1539](https://github.com/polkadot-js/extension/pull/1539))
...
- Fix typo on https://js.pezkuwichain.app/docs/ (Thanks to https://github.com/michaelhealyco)
